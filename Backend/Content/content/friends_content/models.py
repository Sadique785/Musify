...
class FriendList(models.Model):
    user = models.OneToOneField(ContentUser, on_delete=models.CASCADE, related_name='friends_list')
    friends = models.ManyToManyField(ContentUser, related_name='friend_of', blank=True)
...
class FriendRequest(models.Model):
    sender = models.ForeignKey(ContentUser, on_delete=models.CASCADE, related_name='sent_requests')
    receiver = models.ForeignKey(ContentUser, on_delete=models.CASCADE, related_name='received_requests')
