...
# SECRET_KEY = 'django-insecure-hvz+9+@z-=z^$dhvx+zv-)fet1mor6r9k#2$un)x7ac)fjz^p+'
...
AUTH_USER_MODEL = 'notification.ConnectionUser'
...
REST_FRAMEWORK = {
  ...
  'DEFAULT_AUTHENTICATION_CLASSES': (
      'notification.authenticate.CustomAuthentication',
  ),
}
